...
q = 'plinthosols tropical gully control check dam'
url = f"https://api.crossref.org/works?query={urllib.parse.quote(q)}&select=DOI,title,author,issued,container-title&rows=10&sort=relevance"
