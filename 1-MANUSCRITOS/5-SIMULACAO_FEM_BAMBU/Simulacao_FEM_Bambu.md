---
title: "Taxa de biodegradação como controle dominante da segurança estrutural de paliçadas de bambu com colmo inteiro no manejo de erosão linear"
author:
...
^4^ Universidade Estadual de Feira de Santana (UEFS), Feira de Santana, BA, Brasil
...
O *Bambusa vulgaris* foi tratado como material ortotrópico com propriedades mecânicas iniciais ($t = 0$) obtidas da literatura especializada (Tabela 1). Comportamento ortotrópico análogo foi documentado em compósitos de fibra de bambu de espécies neotropicais próximas, como *Guadua angustifolia*, por meio de ensaios de tração e cisalhamento em corpos de prova extraídos pelo método de peeling rotativo [@iwasaki_et_al_2022] e por caracterização de colmos inteiros em condições brasileiras, na qual foram quantificadas as resistências à flexão, à tração, à compressão e ao cisalhamento ao longo do comprimento do colmo e da espessura da parede [@ghavami_marinho_2005], corroborando a adequação da hipótese ortotrópica para a família Poaceae. O módulo de elasticidade longitudinal (12 GPa), a resistência à tração (180 MPa) e a resistência ao cisalhamento interlaminar (10 MPa) representam a faixa superior de valores reportados para a espécie em condições de colheita madura e sem tratamento preservativo [@huzita_noda_kayo_2020; @ghimire_et_al_2013; @ghavami_marinho_2005].
...
A cunha de sedimentos a montante preencheu progressivamente o volume de armazenamento entre colmos durante o período de monitoramento 2023–2025 (Fig. 9a), com obstrução quase completa da face permeável consistente com os tempos de saturação de 1,0 a 4,8 anos previstos pelo modelo (Tabela 2) e com a dinâmica de colmatação rápida impulsionada por chuvas de alta energia sobre Plintossolos. Paralelamente, colonização xilófaga por cupins subterrâneos (Isoptera) foi identificada ao longo das interfaces colmo–estaca e nos diafragmas nodais (Fig. 9b), onde galerias penetraram os planos interlaminares e consumiram seletivamente o tecido parenquimático, padrão consistente com o ataque preferencial ao parênquima rico em amido reportado para espécies de *Bambusa* e *Dendrocalamus* [@brito_paes_oliveira_2020; @kadir_abd_hamid_2024]. A redução resultante da espessura efetiva da parede compromete a resistência ao cisalhamento interlaminar nas mesmas zonas onde o critério de Tsai-Hill concentrou 98 % do índice de falha, corroborando a preocupação mais ampla de que a biodegradação constitui o principal limitante de durabilidade para fibras de origem vegetal empregadas em estruturas geotécnicas [@shalchian_arabani_2023].

A coincidência espacial entre a deterioração lignocelulósica mediada por cupins e o ponto de concentração de cisalhamento previsto pelo modelo sugere que a degradação biológica pode amplificar a vulnerabilidade estrutural precisamente nos elementos com maior demanda mecânica [@kadir_abd_hamid_2024], fornecendo evidência de campo consistente com a predição de que a taxa de degradação do material governa a trajetória do fator de segurança de longo prazo de modo mais decisivo do que o regime de carregamento hidrológico [@shalchian_arabani_2023; @leng_xu_chen_2023].

![**Figura 9** -- Evidência de campo dos dois mecanismos limitantes do desempenho da paliçada. (a) Cunha de sedimentos preenchendo o volume de armazenamento a montante da paliçada; (b) deterioração xilófaga de colmo de *Bambusa vulgaris* por cupins subterrâneos (Isoptera)](figuras/versao_EN/figura_paliçada_2.png){width="6.5in"}
