...
![**Figura 6** -- Distribuição vertical das tensões máximas de flexão ($\sigma_b$, painel esquerdo) e cisalhamento ($\tau_s$, painel direito) nos colmos do segmento MED sob cenário P95 pessimista, em três instantes (0, 5 e 10 anos).](figuras/versao_PT/Fig_5_stress_height.png){width="6.5in"}
