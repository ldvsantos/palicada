...
## Statement (to be inserted in the manuscript before the References section)
...
> **Note:** CRediT taxonomy reference: https://credit.niso.org/  
> This statement must appear in the published article. Copy the "Statement" section above into the manuscript text between the Acknowledgements and the References sections.
