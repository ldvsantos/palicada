...
def gantt():
    ...
    ax.legend(handles=leg, loc="lower center", fontsize=6.5,
              frameon=True, fancybox=False, edgecolor="#D1D5DB",
              ncol=6, bbox_to_anchor=(0.45, -0.12))
