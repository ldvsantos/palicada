...
We are pleased to submit the enclosed manuscript entitled \textbf{``Parametric identifiability of a multiplicative USLE erodibility correction for Plinthosols with subsurface hydraulic impedance''} for consideration as an Original Research Article in \textit{Environmental Earth Sciences}.
